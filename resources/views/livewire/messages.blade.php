        ...
        <table class="w-full text-sm text-left rtl:text-right text-body">
            <thead class="bg-neutral-secondary-soft border-b border-default">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3 font-medium">Conteúdo</th>
                ...
                @forelse ($messages as $message)
                    <tr class="odd:bg-neutral-primary even:bg-neutral-secondary-soft border-b border-default">
                        ...
                        <td class="px-6 py-4 space-x-2">
                            ...
                            <flux:button wire:click="delete({{ $message->id }})" variant="danger" class="cursor-pointer">Excluir</flux:button>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="3" class="px-4 py-2 text-center text-gray-500">Nenhum recado encontrado.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
    ...
    <flux:modal name="delete-message" class="min-w-[22rem]">
        <div class="space-y-6">
            ...
            <div class="flex gap-2">
                ...
                <flux:button type="submit" variant="danger" wire:click="confirmDelete()" class="cursor-pointer">
                    Excluir Recado
                </flux:button>
            </div>
        </div>
